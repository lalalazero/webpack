...
class HotModuleReplacementPlugin {
	...
	static getParserHooks(parser) {
		...
		if (hooks === undefined) {
			hooks = {
				hotAcceptCallback: new SyncBailHook(["expression", "requests"], 'HotModuleReplacementPlugin.hotAcceptCallback'),
				hotAcceptWithoutCallback: new SyncBailHook(["expression", "requests"], 'HotModuleReplacement.hotAcceptWithoutCallback')
			};
