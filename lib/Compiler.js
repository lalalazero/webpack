...
class Compiler {
	...
	constructor(context, options = /** @type {WebpackOptions} */ ({})) {
		this.hooks = Object.freeze({
			...
			/** @type {AsyncParallelHook<[Compilation]>} */
			finishMake: new AsyncSeriesHook(["compilation"], "compiler.finishMake"),
			/** @type {AsyncSeriesHook<[Compilation]>} */
			...
			/** @type {AsyncSeriesHook<[]>} */
			readRecords: new AsyncSeriesHook([], "compiler.readRecords"),
			/** @type {AsyncSeriesHook<[]>} */
			emitRecords: new AsyncSeriesHook([], "compiler.emitRecords"),
			...
			/** @type {AsyncSeriesHook<[]>} */
			shutdown: new AsyncSeriesHook([], "compiler.shutdown"),

			/** @type {SyncBailHook<[string, string, any[]], true>} */
			infrastructureLog: new SyncBailHook(
				["origin", "type", "args"],
				"compiler.infrastructureLog"
			),
