	...
	constructor(sourceType = "auto") {
		...
		this.hooks = Object.freeze({
			...
			evaluateTypeof: new HookMap(
				() =>
					new SyncBailHook(["expression"], "JavascriptParser.evaluateTypeof")
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], BasicEvaluatedExpression | undefined | null>>} */
			evaluate: new HookMap(
				() => new SyncBailHook(["expression"], "JavascriptParser.evaluate")
			),
			...
			evaluateIdentifier: new HookMap(
				() =>
					new SyncBailHook(
						["expression"],
						"JavascriptParser.evaluateIdentifier"
					)
			),
			...
			evaluateDefinedIdentifier: new HookMap(
				() =>
					new SyncBailHook(
						["expression"],
						"JavascriptParser.evaluateDefinedIdentifier"
					)
			),
			...
			evaluateNewExpression: new HookMap(
				() =>
					new SyncBailHook(
						["expression"],
						"JavascriptParser.evaluateNewExpression"
					)
			),
			...
			evaluateCallExpression: new HookMap(
				() =>
					new SyncBailHook(
						["expression"],
						"JavascriptParser.evaluateCallExpression"
					)
			),
			...
			evaluateCallExpressionMember: new HookMap(
				() =>
					new SyncBailHook(
						["expression", "param"],
						"JavascriptParser.evaluateCallExpressionMember"
					)
			),
			...
			isPure: new HookMap(
				() =>
					new SyncBailHook(
						["expression", "commentsStartPosition"],
						"JavascriptParser.isPure"
					)
			),
			/** @type {SyncBailHook<[StatementNode | ModuleDeclarationNode], boolean | void>} */
			preStatement: new SyncBailHook(
				["statement"],
				"JavascriptParser.preStatement"
			),

			/** @type {SyncBailHook<[StatementNode | ModuleDeclarationNode], boolean | void>} */
			blockPreStatement: new SyncBailHook(
				["declaration"],
				"JavascriptParser.blockPreStatement"
			),
			/** @type {SyncBailHook<[StatementNode | ModuleDeclarationNode], boolean | void>} */
			statement: new SyncBailHook(["statement"], "JavascriptParser.statement"),
			/** @type {SyncBailHook<[IfStatementNode], boolean | void>} */
			statementIf: new SyncBailHook(
				["statement"],
				"JavascriptParser.statementIf"
			),
			/** @type {SyncBailHook<[ExpressionNode, ClassExpressionNode | ClassDeclarationNode], boolean | void>} */
			classExtendsExpression: new SyncBailHook(
				["expression", "classDefinition"],
				"JavascriptParser.classExtendsExpression"
			),
			/** @type {SyncBailHook<[MethodDefinitionNode | PropertyDefinitionNode, ClassExpressionNode | ClassDeclarationNode], boolean | void>} */
			classBodyElement: new SyncBailHook(
				["element", "classDefinition"],
				"JavascriptParser.classBodyElement"
			),
			...
			export: new SyncBailHook(["statement"], "JavascriptParser.export"),
			...
			exportImportSpecifier: new SyncBailHook(
				...
				"JavascriptParser.varDeclaration"
			),
			/** @type {SyncBailHook<[VariableDeclaratorNode, StatementNode], boolean | void>} */
			preDeclarator: new SyncBailHook(
				["declarator", "statement"],
				"JavascriptParser.preDeclarator"
			),
			/** @type {SyncBailHook<[VariableDeclaratorNode, StatementNode], boolean | void>} */
			declarator: new SyncBailHook(
				["declarator", "statement"],
				"JavascriptParser.declarator"
			),
			/** @type {HookMap<SyncBailHook<[DeclarationNode], boolean | void>>} */
			varDeclaration: new HookMap(
				() =>
					new SyncBailHook(["declaration"], "JavascriptParser.varDeclaration")
			),
			/** @type {HookMap<SyncBailHook<[DeclarationNode], boolean | void>>} */
			varDeclarationLet: new HookMap(
				() =>
					new SyncBailHook(
						["declaration"],
						"JavascriptParser.varDeclarationLet"
					)
			),
			/** @type {HookMap<SyncBailHook<[DeclarationNode], boolean | void>>} */
			varDeclarationConst: new HookMap(
				() =>
					new SyncBailHook(
						["declaration"],
						"JavascriptParser.varDeclarationConst"
					)
			),
			/** @type {HookMap<SyncBailHook<[DeclarationNode], boolean | void>>} */
			varDeclarationVar: new HookMap(
				() =>
					new SyncBailHook(
						["declaration"],
						"JavascriptParser.varDeclarationVar"
					)
			),
			/** @type {HookMap<SyncBailHook<[IdentifierNode], boolean | void>>} */
			pattern: new HookMap(
				() => new SyncBailHook(["pattern"], "JavascriptParser.pattern")
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], boolean | void>>} */
			canRename: new HookMap(
				() => new SyncBailHook(["initExpression"], "JavascriptParser.canRename")
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], boolean | void>>} */
			rename: new HookMap(
				() => new SyncBailHook(["initExpression"], "JavascriptParser.rename")
			),
			/** @type {HookMap<SyncBailHook<[import("estree").AssignmentExpression], boolean | void>>} */
			assign: new HookMap(
				() => new SyncBailHook(["expression"], "JavascriptParser.assign")
			),
			...
			assignMemberChain: new HookMap(
				() =>
					new SyncBailHook(
						["expression", "members"],
						"JavascriptParser.assignMemberChain"
					)
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], boolean | void>>} */
			typeof: new HookMap(
				() => new SyncBailHook(["expression"], "JavascriptParser.typeof")
			),
			/** @type {SyncBailHook<[ExpressionNode], boolean | void>} */
			importCall: new SyncBailHook(
				["expression"],
				"JavascriptParser.importCall"
			),
			/** @type {SyncBailHook<[ExpressionNode], boolean | void>} */
			topLevelAwait: new SyncBailHook(
				["expression"],
				"JavascriptParser.topLevelAwait"
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], boolean | void>>} */
			call: new HookMap(
				() => new SyncBailHook(["expression"], "JavascriptParser.call")
			),
			/** Something like "a.b()" */
			...
			callMemberChain: new HookMap(
				() =>
					new SyncBailHook(
						...
						"JavascriptParser.callMemberChain"
					)
			),
			...
			memberChainOfCallMemberChain: new HookMap(
				() =>
					new SyncBailHook([
						...
						"callExpression",
						"members"
					], 'JavascriptParser.memberChainOfCallMemberChain')
			),
			/** Something like "a.b().c.d()"" */
			/** @type {HookMap<SyncBailHook<[ExpressionNode, string[], CallExpressionNode, string[]], boolean | void>>} */
			callMemberChainOfCallMemberChain: new HookMap(
				() =>
					new SyncBailHook([
						...
						"innerCallExpression",
						"members"
					], 'JavascriptParser.callMemberChainOfCallMemberChain')
			),
			/** @type {SyncBailHook<[ChainExpressionNode], boolean | void>} */
			optionalChaining: new SyncBailHook(["optionalChaining"], 'JavascriptParser.optionalChaining'),
			/** @type {HookMap<SyncBailHook<[NewExpressionNode], boolean | void>>} */
			new: new HookMap(() => new SyncBailHook(["expression"], 'JavascriptParser.new')),
			/** @type {SyncBailHook<[BinaryExpressionNode], boolean | void>} */
			binaryExpression: new SyncBailHook(["binaryExpression"], 'JavascriptParser.binaryExpression'),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], boolean | void>>} */
			expression: new HookMap(() => new SyncBailHook(["expression"], 'JavascriptParser.expression')),
			/** @type {HookMap<SyncBailHook<[ExpressionNode, string[], boolean[]], boolean | void>>} */
			expressionMemberChain: new HookMap(
				() => new SyncBailHook(["expression", "members", "membersOptionals"], 'JavascriptParser.expressionMemeberChain')
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode, string[]], boolean | void>>} */
			unhandledExpressionMemberChain: new HookMap(
				() => new SyncBailHook(["expression", "members"], 'JavascriptParser.unhandledExpressionMemberChain')
			),
			/** @type {SyncBailHook<[ExpressionNode], boolean | void>} */
			expressionConditionalOperator: new SyncBailHook(["expression"], 'JavascriptParser.expressionConditionalOperator'),
			/** @type {SyncBailHook<[ExpressionNode], boolean | void>} */
			expressionLogicalOperator: new SyncBailHook(["expression"], 'JavascriptParser.expressionLogicalOperator'),
			/** @type {SyncBailHook<[ProgramNode, CommentNode[]], boolean | void>} */
			program: new SyncBailHook(["ast", "comments"], 'JavascriptParser.program'),
			/** @type {SyncBailHook<[ProgramNode, CommentNode[]], boolean | void>} */
			finish: new SyncBailHook(["ast", "comments"], 'JavascriptParser.finish')
		});
