		...
		if (hooks === undefined) {
			hooks = {
				...
				render: new SyncWaterfallHook(
					...
					"JavascriptModulesPlugin.render"
				),
				renderContent: new SyncWaterfallHook(
					["source", "renderContext"],
					"JavascriptModulesPlugin.renderContent"
				),
				renderStartup: new SyncWaterfallHook(
					["source", "module", "startupRenderContext"],
					"JavascriptModulesPlugin.renderStartup"
				),
				renderChunk: new SyncWaterfallHook(
					["source", "renderContext"],
					"JavascriptModulesPlugin.renderChunk"
				),
				renderMain: new SyncWaterfallHook(
					["source", "renderContext"],
					"JavascriptModulesPlugin.renderMain"
				),
				renderRequire: new SyncWaterfallHook(
					["code", "renderContext"],
					"JavascriptModulesPlugin.renderRequire"
				),
				inlineInRuntimeBailout: new SyncBailHook(
					["module", "renderContext"],
					"JavascriptModulesPlugin.inlineInRuntimeBailout"
				),
				embedInRuntimeBailout: new SyncBailHook(
					["module", "renderContext"],
					"JavascriptModulesPlugin.embedInRuntimeBailout"
				),
				strictRuntimeBailout: new SyncBailHook(
					["renderContext"],
					"JavascriptModulesPlugin.strictRuntimeBailout"
				),
				chunkHash: new SyncHook(
					["chunk", "hash", "context"],
					"JavascriptModulesPlugin.chunkHash"
				),
				useSourceMap: new SyncBailHook(
					["chunk", "renderContext"],
					"JavascriptModulesPlugin.useSourceMap"
				)
			};
