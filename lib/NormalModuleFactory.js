		...
		this.hooks = Object.freeze({
			...
			resolveForScheme: new HookMap(
				() =>
					new AsyncSeriesBailHook(
						["resourceData", "resolveData"],
						"NormalModuleFactory.resolveForScheme"
					)
			),
			/** @type {HookMap<AsyncSeriesBailHook<[ResourceDataWithData, ResolveData], true | void>>} */
			resolveInScheme: new HookMap(
				() =>
					new AsyncSeriesBailHook(
						["resourceData", "resolveData"],
						"NormalModuleFactory.resolveInScheme"
					)
			),
			/** @type {AsyncSeriesBailHook<[ResolveData], Module>} */
			factorize: new AsyncSeriesBailHook(
				["resolveData"],
				"NormalModuleFactory.factorize"
			),
			...
			createGenerator: new HookMap(
				() =>
					new SyncBailHook(
						["generatorOptions"],
						"NormalModuleFactory.createGenerator"
					)
			),
			...
			createModuleClass: new HookMap(
				() =>
					new SyncBailHook(
						["createData", "resolveData"],
						"NormalModuleFactory.createModuleClass"
					)
			)
		});
