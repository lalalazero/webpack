...
module.exports = class ContextModuleFactory extends ModuleFactory {
	...
	constructor(resolverFactory) {
		...
		const alternativeRequests = new AsyncSeriesWaterfallHook([
			"modules",
			"options"
		], 'ContextModuleFactory.alternativeRequests');
		this.hooks = Object.freeze({
			/** @type {AsyncSeriesWaterfallHook<[TODO]>} */
			beforeResolve: new AsyncSeriesWaterfallHook(["data"], 'ContextModuleFactory.beforeResolve'),
			/** @type {AsyncSeriesWaterfallHook<[TODO]>} */
			afterResolve: new AsyncSeriesWaterfallHook(["data"], 'ContextModuleFactory.afterResolve'),
			/** @type {SyncWaterfallHook<[string[]]>} */
			contextModuleFiles: new SyncWaterfallHook(["files"], 'ContextModuleFactory.contextModuleFiles'),
