...
class Compilation {
	...
	constructor(compiler, params) {
		...
		const afterProcessAssetsHook = new SyncHook(
			["assets"],
			"Compilation.afterProcessAssetsHook"
		);
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
		...
		this.hooks = Object.freeze({
			...
			failedModule: new SyncHook(
				["module", "error"],
				"compilation.failedModule"
			),
			/** @type {SyncHook<[Module]>} */
			...
			stillValidModule: new SyncHook(
				["module"],
				"compilation.stillValidModule"
			),

			/** @type {SyncHook<[Dependency, EntryOptions]>} */
			addEntry: new SyncHook(["entry", "options"], "compilation.addEntry"),
			/** @type {SyncHook<[Dependency, EntryOptions, Error]>} */
			failedEntry: new SyncHook(
				["entry", "options", "error"],
				"compilation.failedEntry"
			),
			...
			prepareModuleExecution: new AsyncParallelHook(
				["options", "context"],
				"compilation.prepareModuleExecution"
			),
			...
			finishRebuildingModule: new AsyncSeriesHook(
				["module"],
				"compilation.finishRebuildingModule"
			),
			/** @type {SyncHook<[]>} */
			...
			optimizeDependencies: new SyncBailHook(
				["modules"],
				"compilation.optimizeDependencies"
			),
			/** @type {SyncHook<[Iterable<Module>]>} */
			afterOptimizeDependencies: new SyncHook(
				["modules"],
			...
			afterOptimizeTree: new SyncHook(
				["chunks", "modules"],
			...
			/** @type {SyncHook<[Iterable<Chunk>, Iterable<Module>]>} */
			afterOptimizeChunkModules: new SyncHook(
				["chunks", "modules"],
			...
			runtimeRequirementInChunk: new HookMap(
				() =>
					new SyncBailHook(
						["chunk", "runtimeRequirements", "context"],
						"compilation.runtimeRequirementInChunk"
					)
			),
			...
			/** @type {SyncHook<[Iterable<Module>]>} */
			optimizeModuleIds: new SyncHook(
				["modules"],
				"compilation.optimizeModuleIds"
			),
			/** @type {SyncHook<[Iterable<Module>]>} */
			afterOptimizeModuleIds: new SyncHook(
				["modules"],
				"compilation.afterOptimizeModuleIds"
			),

			/** @type {SyncHook<[Iterable<Chunk>, any]>} */
			reviveChunks: new SyncHook(
				["chunks", "records"],
			...
			/** @type {SyncHook<[Iterable<Chunk>]>} */
			optimizeChunkIds: new SyncHook(
				["chunks"],
				"compilation.optimizeChunkIds"
			),
			/** @type {SyncHook<[Iterable<Chunk>]>} */
			afterOptimizeChunkIds: new SyncHook(
				["chunks"],
				"compilation.afterOptimizeChunkIds"
			),

			/** @type {SyncHook<[Iterable<Module>, any]>} */
			recordModules: new SyncHook(
				["modules", "records"],
				"compilation.recordModules"
			),
			/** @type {SyncHook<[Iterable<Chunk>, any]>} */
			recordChunks: new SyncHook(
				["chunks", "records"],
				"compilation.recordChunks"
			),

			/** @type {SyncHook<[Iterable<Module>]>} */
			optimizeCodeGeneration: new SyncHook(
				["modules"],
				"compilation.optimizeCodeGeneration"
			),
			...
			beforeCodeGeneration: new SyncHook(
				[],
				"compilation.beforeCodeGeneration"
			),
			/** @type {SyncHook<[]>} */
			...
			beforeRuntimeRequirements: new SyncHook(
				[],
				"compilation.beforeRuntimeRequirements"
			),
			/** @type {SyncHook<[]>} */
			afterRuntimeRequirements: new SyncHook(
				[],
				"compilation.afterRuntimeRequirements"
			),
			...
			processAdditionalAssets: new AsyncSeriesHook(
				["assets"],
				"compilation.processAdditionalAssets"
			),
			...
			chunkHash: new SyncHook(
				["chunk", "chunkHash", "ChunkHashContext"],
				"compilation.chunkHash"
			),

			/** @type {SyncHook<[Module, string]>} */
			moduleAsset: new SyncHook(
				["module", "filename"],
				"compilation.moduleAsset"
			),
			...
			assetPath: new SyncWaterfallHook(
				["path", "options", "assetInfo"],
				"compilation.assetPath"
			),
