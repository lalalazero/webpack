...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
		...
		this.hooksOrigin = Object.freeze({
		...
		this.hooks = new Proxy(this.hooksOrigin, {
			get(target, prop) {
				log(null, 'diff-compilation-hooks-runtime.txt', true)
				log(prop, 'compilation-hooks-runtime.txt')
				return target[prop]
			}
		})
		/** @type {string=} */
