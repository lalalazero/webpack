...
class Compilation {
	...
	constructor(compiler, params) {
		...
		const processAssetsHook = new AsyncSeriesHook(["assets"], 'Compilation.processAssetsHook');
		...
		const afterProcessAssetsHook = new SyncHook(["assets"], 'Compilation.afterProcessAssetsHook');
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
		...
		this.hooks = Object.freeze({
			...
			/** @type {SyncHook<[Module]>} */
			stillValidModule: new SyncHook(["module"], 'compilation.stillValidModule'),

			/** @type {SyncHook<[Dependency, EntryOptions]>} */
			addEntry: new SyncHook(["entry", "options"], 'compilation.addEntry'),
			/** @type {SyncHook<[Dependency, EntryOptions, Error]>} */
			failedEntry: new SyncHook(["entry", "options", "error"], 'compilation.failedEntry'),
			/** @type {SyncHook<[Dependency, EntryOptions, Module]>} */
			succeedEntry: new SyncHook(["entry", "options", "module"], 'compilation.succeedEntry'),
			...
			dependencyReferencedExports: new SyncWaterfallHook([
				...
				"dependency",
				"runtime"
			], 'compilation.dependencyReferencedExports'),

			/** @type {SyncHook<[ExecuteModuleArgument, ExecuteModuleContext]>} */
			executeModule: new SyncHook(["options", "context"], 'compilation.executeModule'),
			/** @type {AsyncParallelHook<[ExecuteModuleArgument, ExecuteModuleContext]>} */
			prepareModuleExecution: new AsyncParallelHook(["options", "context"], 'compilation.prepareModuleExecution'),

			/** @type {AsyncSeriesHook<[Iterable<Module>]>} */
			finishModules: new AsyncSeriesHook(["modules"], 'compilation.finishModules'),
			/** @type {AsyncSeriesHook<[Module]>} */
			finishRebuildingModule: new AsyncSeriesHook(["module"], 'compilation.finishRebuildingModule'),
			/** @type {SyncHook<[]>} */
			...
			optimizeChunkModules: new AsyncSeriesBailHook(["chunks", "modules"], 'compilation.optimizeChunkModules'),
			/** @type {SyncHook<[Iterable<Chunk>, Iterable<Module>]>} */
			...
			additionalChunkRuntimeRequirements: new SyncHook([
				...
				"runtimeRequirements",
				"context"
			], 'compilation.additionalChunkRuntimeRequirements'),
			/** @type {HookMap<SyncBailHook<[Chunk, Set<string>, RuntimeRequirementsContext]>>} */
			runtimeRequirementInChunk: new HookMap(
				() => new SyncBailHook(["chunk", "runtimeRequirements", "context"], 'compilation.runtimeRequirementInChunk')
			),
			...
			additionalModuleRuntimeRequirements: new SyncHook([
				...
				"runtimeRequirements",
				"context"
			], 'compilation.additionalModuleRuntimeRequirements'),
			/** @type {HookMap<SyncBailHook<[Module, Set<string>, RuntimeRequirementsContext]>>} */
			runtimeRequirementInModule: new HookMap(
				() => new SyncBailHook(["module", "runtimeRequirements", "context"], 'compilation.runtimeRequirementInModule')
			),
			/** @type {SyncHook<[Chunk, Set<string>, RuntimeRequirementsContext]>} */
			...
			runtimeRequirementInTree: new HookMap(
				() => new SyncBailHook(["chunk", "runtimeRequirements", "context"], 'compilation.runtimeRequirementInTree')

			),

			/** @type {SyncHook<[RuntimeModule, Chunk]>} */
			runtimeModule: new SyncHook(["module", "chunk"], 'compilation.runtimeModule'),
			...
			/** @type {SyncHook<[Iterable<Chunk>]>} */
			chunkIds: new SyncHook(["chunks"], 'compilation.chunkIds'),
			/** @type {SyncHook<[Iterable<Chunk>]>} */
			...
			/** @type {SyncHook<[Iterable<Module>]>} */
			optimizeCodeGeneration: new SyncHook(["modules"], 'compilation.optimizeCodeGeneration'),

			/** @type {SyncHook<[]>} */
			beforeModuleHash: new SyncHook([], 'compilation.beforeModuleHash'),
			/** @type {SyncHook<[]>} */
			afterModuleHash: new SyncHook([], 'compilation.afterModuleHash'),

			/** @type {SyncHook<[]>} */
			beforeCodeGeneration: new SyncHook([], 'compilation.beforeCodeGeneration'),
			/** @type {SyncHook<[]>} */
			afterCodeGeneration: new SyncHook([], 'compilation.afterCodeGeneration'),

			/** @type {SyncHook<[]>} */
			beforeRuntimeRequirements: new SyncHook([], 'compilation.beforeRuntimeRequirements'),
			/** @type {SyncHook<[]>} */
			afterRuntimeRequirements: new SyncHook([], 'compilation.afterRuntimeRequirements'),
			...
			processAdditionalAssets: new AsyncSeriesHook(["assets"], 'compilation.processAdditionalAssets'),
			...
			renderManifest: new SyncWaterfallHook(["result", "options"], 'compilation.renderManifest'),

			/** @type {SyncHook<[Hash]>} */
			fullHash: new SyncHook(["hash"], 'compilation.fullHash'),
			/** @type {SyncHook<[Chunk, Hash, ChunkHashContext]>} */
			chunkHash: new SyncHook(["chunk", "chunkHash", "ChunkHashContext"], 'compilation.chunkHash'),
			...
			assetPath: new SyncWaterfallHook(["path", "options", "assetInfo"], 'compilation.assetPath'),
			...
			processWarnings: new SyncWaterfallHook(["warnings"], 'compilation.processWarnings'),
			/** @type {SyncWaterfallHook<[WebpackError[]]>} */
			processErrors: new SyncWaterfallHook(["errors"], 'compilation.processErrors'),

			/** @type {HookMap<SyncHook<[Partial<NormalizedStatsOptions>, CreateStatsOptionsContext]>>} */
			statsPreset: new HookMap(() => new SyncHook(["options", "context"], 'compilation.statsPreset')),
			/** @type {SyncHook<[Partial<NormalizedStatsOptions>, CreateStatsOptionsContext]>} */
			statsNormalize: new SyncHook(["options", "context"], 'compilation.statsNormalize'),
			/** @type {SyncHook<[StatsFactory, NormalizedStatsOptions]>} */
			statsFactory: new SyncHook(["statsFactory", "options"], 'compilation.statsFactory'),
			/** @type {SyncHook<[StatsPrinter, NormalizedStatsOptions]>} */
			statsPrinter: new SyncHook(["statsPrinter", "options"], 'compilation.statsPrinter'),
