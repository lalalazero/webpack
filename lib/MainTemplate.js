...
class MainTemplate {
	...
	constructor(outputOptions, compilation) {
		...
		this.hooks = Object.freeze({
			...
			localVars: new SyncWaterfallHook(["source", "chunk", "hash"], 'MainTemplate.localVars'),
			/** @type {SyncWaterfallHook<[string, Chunk, string]>} */
			requireExtensions: new SyncWaterfallHook(["source", "chunk", "hash"], 'MainTemplate.requireExtensions'),
