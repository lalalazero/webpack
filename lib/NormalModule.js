...
class NormalModule extends Module {
	...
	static getCompilationHooks(compilation) {
		...
		if (hooks === undefined) {
			hooks = {
				loader: new SyncHook(["loaderContext", "module"], 'NormalModule.loader'),
				beforeLoaders: new SyncHook(["loaders", "module", "loaderContext"], 'NormalModule.beforeLoaders'),
				beforeParse: new SyncHook(["module"], 'NormalModule.beforeParse'),
				beforeSnapshot: new SyncHook(["module"], 'NormalModule.beforeSnapshot'),
				...
				readResource: new HookMap(
					() => new AsyncSeriesBailHook(["loaderContext"], 'NormalModule.readResource')
				),
				needBuild: new AsyncSeriesBailHook(["module", "context"], 'NormalModule.needBuild')
			};
